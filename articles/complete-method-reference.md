...
#> + edges from bd3f3d4 (vertex names):
...
#> + edges from 4ee6686 (vertex names):
...
#> + edges from 5c33d05 (vertex names):
#> [1] 1->2 1->3 3->6 3->7
```
...
#> | (e/c)
#> + edges from ca9dce7 (vertex names):
...
#> + edges from 62e98d6 (vertex names):
#> [1] 0-0->0-1 0-0->0-2
```
